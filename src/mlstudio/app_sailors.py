...
def make_plots(df_clean: pd.DataFrame, model: LinearRegression) -> None:
    ...
    plt.tight_layout()
    plt.savefig("data/raw/hours_vs_score.png")

    LOG.info("Saved plot: hours_vs_score.png")
    ...
    plt.tight_layout()
    plt.savefig("data/raw/model_coefficients.png")

    LOG.info("Saved plot: model_coefficients.png")
